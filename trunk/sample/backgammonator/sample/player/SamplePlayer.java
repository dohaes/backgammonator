package backgammonator.sample.player;

import backgammonator.impl.protocol.AbstractPlayer;
...
public class SamplePlayer extends AbstractPlayer {
	...
	/**
	 * @see backgammonator.lib.game.Player#getName()
	 */
	...
	/**
	 * @see backgammonator.lib.game.Player#gameOver(backgammonator.lib.game.BackgammonBoard,
	 *      boolean, backgammonator.lib.game.GameOverStatus)
	 */
	...
	/**
	 * @see backgammonator.lib.game.Player#getMove(backgammonator.lib.game.BackgammonBoard,
	 *      backgammonator.lib.game.Dice)
	 */
	...
	final class InternalBoard {
		...
		public InternalBoard(BackgammonBoard board) {
			...
			for (int i = 1; i < 25; i++) {
				...
				pos[i] = p.getCount()
						* (p.getColor() == board.getCurrentPlayerColor() ? 1
								: -1);
			}
		}
