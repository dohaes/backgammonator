...
public class GameLoggerTestCase extends TestCase {
	...
	/**
	 * Tests logging regular game over.
	 */
	...
	/**
	 * Tests logging invalid move on game over.
	 */
	public void testInvalidMoveEndGame() {
		...
		String filename = BackgammonatorConfig.getProperty("backgammonator.logger.outputDir") + File.separator
	...
	/**
	 * Tests logging exception on game over.
	 */
